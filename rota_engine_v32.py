    ...
    for w in range(weeks):
                ...
                for site, ws_site2 in site_sheets.items():
                    ...
                    for nm in staff_names:
                        ...
                        if hk:
                            ...
                            ds = display_site_for_assignment(role, d, nm, staff_by_name)
        ...
        for d in dates:
            for t in slots:
                ...
                row.append(", ".join([nm for nm in staff_names if a.get((d,t,nm))=="Emis_Tasks"]))
                row.append(", ".join([nm for nm in staff_names if a.get((d,t,nm))=="Docman_Tasks"]))
        ...
        # Colour coverage columns by meaning
            ...
            "EMIS": PatternFill("solid", fgColor=ROLE_COLORS.get("Emis_Tasks","EAD1DC")),
            "Docman": PatternFill("solid", fgColor=ROLE_COLORS.get("Docman_Tasks","D0E0E3")),
